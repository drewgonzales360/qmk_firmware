...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER2] = LAYOUT(RGB_HUD, RGB_HUI, RGB_SAD, RGB_SAI, RGB_VAD, RGB_VAI, KC_P7, KC_P8, KC_P9, KC_PAST, KC_PSLS, RGB_MOD, KC_PLUS, KC_EXLM, KC_COLN, KC_PEQL, KC_AMPR, KC_GRV, KC_P4, KC_P5, KC_P6, KC_MINS, KC_PPLS, RGB_RMOD, KC_AT, KC_DLR, KC_PAST, KC_PIPE, KC_PMNS, KC_TILD, KC_P1, KC_P2, KC_P3, KC_EQL, RGB_SPI, KC_VOLU, KC_BSLS, KC_HASH, KC_CIRC, KC_PERC, KC_UNDS, KC_NO, KC_NO, KC_NO, KC_P0, KC_PDOT, KC_PENT, KC_MPLY, RGB_SPD, KC_VOLD, KC_LALT, TO(0), KC_TRNS, KC_TRNS, KC_SPC, KC_RCTL)
};
